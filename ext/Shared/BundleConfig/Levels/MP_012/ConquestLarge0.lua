...
return
{
	...
	terrainAssetName = 'Levels/MP_012/Terrain/MP_012', --string,  // The name of the terrain you want to use (Available for per Level and per Level + GameMode).
	...
	--You can use just [3] or ResourceCompartment.ResourceCompartment_Game, it’s the same.
		[3] = {
			'Levels/XP3_Desert/ConquestLarge0'
			--'Levels/XP3_Desert/ConquestSmall0' --crashes client
			--'Levels/XP3_Desert/RushLarge0' --crashes client
        	}
--[[		,[3] = {
