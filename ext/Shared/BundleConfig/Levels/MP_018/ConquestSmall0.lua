...
return
{
	...
	terrainAssetName = 'Levels/MP_018/Terrain/Terrain_MP018', --string,  // The name of the terrain you want to use (Available for per Level and per Level + GameMode).
	...
	--ou can use just [3] or ResourceCompartment.ResourceCompartment_Game, it’s the same.
		[3] = {
			'Levels/XP3_Desert/ConquestLarge0'
			,'Levels/XP3_Desert/RushLarge0'
        }
