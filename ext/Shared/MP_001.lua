...
-------
	...
	,['TeamDeathMatch0'] = { 
		SubWorldGuids = {
			partitionGuid = Guid('5D9479AA-B0DB-4783-8CD4-F102FA879EA4'), instanceGuid = Guid('324B9235-B18D-4C23-A62D-FB9A809469FA') 
		},
		BundlesToMount = {
			{ 
				SuperBundle = 'XP3Chunks', 
...
Events:Subscribe('Level:RegisterEntityResources', function(p_LevelData)
    ...
    if string.find(levelName, 'MP_001') == nil or gameModeName ~= 'RushLarge0' then
        return
    end
...
Events:Subscribe('Level:RegisterEntityResources', function(p_LevelData)
    ...
    if string.find(levelName, 'MP_001') == nil or gameModeName ~= 'ConquestSmall0' then
        return
    end
...
Events:Subscribe('Level:RegisterEntityResources', function(p_LevelData)
    ...
    if string.find(levelName, 'MP_001') == nil or gameModeName ~= 'ConquestLarge0' then
        return
    end
